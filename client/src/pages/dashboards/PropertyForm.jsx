...
const PropertyForm = ({ onSuccess, onClose }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        {/* Content */}
        <form onSubmit={handleSubmit} className="px-8 pb-8 pt-8 space-y-8 overflow-y-auto flex-1 -mt-px">
          {error && (
            <Alert variant="error">
              {error}
            </Alert>
